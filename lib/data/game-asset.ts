...
export const rpgIconPrompt: PromptCard = {
  ...
  model_notes: [
    { model: "midjourney", version: "v6", note: "Icon centering is stable at a 1:1 ratio. Background removal might require post-processing." }
  ],
...
export const cyberpunkCityPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Highly sophisticated representation of city details and light reflections." }],
...
export const spaceInteriorPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Excellent metal texture and lighting clarity." }],
...
export const lowPolyNaturePrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Very stable expression of simplified geometric forms." }],
...
export const retroArcadeUiPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Exceptional representation of block textures unique to pixel art." }],
...
export const magicVfxPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Superb representation of energy flow and particle density." }],
...
export const cyberpunkAssassinPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Exceptional representation of metal material reflections and neon light sources." }],
...
export const medievalWizardPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Exceptional representation of fabric textures, gold embroidery, and light scattering effects." }],
...
export const mechWarriorPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Mechanical structures and metal corrosion effects are highly realistic." }],
...
export const darkFantasyRoguePrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Superb leather texture and fog representation within dark areas." }],
...
export const steampunkExplorerPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Exceptional texture contrast between copper, brass, and leather." }],
...
export const treasureChestsPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Highly realistic texture contrast between metal sheen and wood grain." }],
...
export const magicPotionsPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Exceptional representation of glass refraction and light sources within fluids." }],
...
export const ancientArtifactsPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Superb spatial sense between floating parts and light source processing." }],
...
export const medievalWeaponsPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Higher precision in metal reflections and decorative patterns compared to other models." }],
...
export const sciFiConsumablesPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Highly realistic textures for futuristic materials like plastic and carbon fiber." }],
...
export const fantasyFloraPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Fantastic representation of plant tissue transparency and bioluminescent particles." }],
...
export const dungeonPropsPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Highly realistic textures for moss and stone, and light source effects for flames." }],
...
export const monsterConceptPrompt: PromptCard = {
  ...
  model_notes: [{ model: "midjourney", version: "v6", note: "Strong representation of biological details like skin texture and muscle definition." }],
